...
<body onload="myFunction('${messageName}','${messageBirthday}')">
                ...
                <form method="post" action="/customer?action=create" id="fomrAdd">
                    <div class="form-group">
                        ...
                        <input type="text" name="customerName" class="form-control" id="exampleInputEmail1"
                               aria-describedby="emailHelp" value="<c:out value='${customer.nameCustomer}'/>"  required pattern="^[A-Z]$">
                        <p>
...
<script type="text/javascript">
    function myFunction(messageName, messageBirthday) {
        console.log(messageBirthday);
        console.log(messageName);
        if (messageName || messageBirthday) {
