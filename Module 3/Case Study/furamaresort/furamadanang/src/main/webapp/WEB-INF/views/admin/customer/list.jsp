                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="old-birthday" name="old-birthday">
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="form-group">
                        ...
                        <div class="col-xl-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="old-customertypeid" id="old-customertypeid">
                                    ...
                                    <c:forEach items="${customerTypeList}" var="customerType">
<%--                                        <c:choose>--%>
                                            <%-- c:when này xử lý trong trường hợp binding dữ liệu cũ lên cho chức năng update --%>
                                            <%-- hoặc input dữ liẹu sai khi validate --%>
<%--                                            <c:when test="${customerType.id.equals(oldCustomer.customerType.id)}">--%>
<%--                                                <option value="${customerType.id}"--%>
<%--                                                        selected>${customerType.customerType}</option>--%>
<%--                                            </c:when>--%>
                                            <%-- show customerType như thường --%>
<%--                                            <c:otherwise>--%>
                                                <option value="${customerType.id}">${customerType.customerType}</option>
<%--                                            </c:otherwise>--%>
<%--                                        </c:choose>--%>
