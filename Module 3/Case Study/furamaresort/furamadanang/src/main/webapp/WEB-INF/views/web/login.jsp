...
<head>
    ...
    <title>Furama Resort| Log in</title>
...
<%
    ...
    if(listCookie != null){
        while(co < listCookie.length){
            System.out.println(listCookie[co].getName());
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="/?action=login" method="post">
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" placeholder="Password"  value="<%out.print(pass);%>" name="password" id="password">
                    <div class="input-group-append">
                        <div class="input-group-text">
